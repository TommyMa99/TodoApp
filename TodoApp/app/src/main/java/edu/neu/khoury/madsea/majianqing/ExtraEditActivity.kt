...
class ExtraEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.extra_edit)
    ...
    fun saveAction(view: View) {
        val uid :String = intent.getStringExtra("value") as String
        val itemReference=database.child("todo").child(uid)
        val todoItemData = TodoModule.createList()
        ...
        todoItemData.UID = itemReference.key
